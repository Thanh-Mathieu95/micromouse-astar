...
Transform::Transform() : Node("transform_node"),
    ...
    this->declare_parameter<std::string>("parents_frame");
    this->declare_parameter<std::string>("child_frame");
    this->declare_parameter<std::double_t>("x");
    this->declare_parameter<std::double_t>("y");
    this->declare_parameter<std::double_t>("z");
    this->declare_parameter<std::double_t>("roll");
    this->declare_parameter<std::double_t>("pitch");
    this->declare_parameter<std::double_t>("yaw");
    this->get_parameter_or<std::string>("parents_frame", parents_frame, "odom");
    this->get_parameter_or<std::string>("child_frame", child_frame, "base_link");//laser
